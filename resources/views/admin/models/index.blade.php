...
@section('content')
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalModel" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
                ...
                <tbody>
                    @foreach ($models as $model)
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-warning btnEditar" id="{{ $model->id }}"> <i
                                        class="fas fa-edit"></i></button>
                                <form action="{{ route('admin.models.destroy', $model->id) }}"
                                    id="delete-form-{{ $model->id }}" method="POST" class="d-inline formDelete">
                                    @csrf
                                    @method('DELETE')
