...
@section('content')
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalVehicle" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button id="btnNewVehicle" class="btn btn-primary"><i class="fas fa-plus"></i> Agregar Nuevo
                    Vehículo</button>
            </div>
        </div>
            ...
            var table = $('#datatableVehicles').DataTable({
                ...
                columns: [{
                        ...
                        render: function(data) {
                            const defaultImage = '{{ asset('storage/brand_logo/no_image.png') }}';
                ...
                order: [
                    [7, 'desc']
                ] // Se usa el índice 7 correspondiente a "ACTUALIZADO"
            });
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            error: function(xhr) {
                                let res = xhr.responseJSON;
                                Swal.fire('¡Error!', res?.message || 'Ocurrió un error',
                                    'error');
                            }
                        });
                    }
