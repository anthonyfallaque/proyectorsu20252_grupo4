    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="time" class="form-control" id="hour_in" name="hour_in" value="{{ old('hour_in', $shift->hour_in) }}" required>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="time" class="form-control" id="hour_out" name="hour_out" value="{{ old('hour_out', $shift->hour_out) }}" required>
                <small class="form-text text-muted">Formato de 24 horas</small>
            </div>
        </div>
    </div>
