...
@section('content')
    ...
    <!-- Modal -->
    <div class="modal fade " id="modalBrand" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
                ...
                <tbody>
                    @foreach ($brands as $brand)
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-warning btnEditar" id="{{ $brand->id }}"> <i
                                        class="fas fa-edit"></i></button>
                                <form action="{{ route('admin.brands.destroy', $brand->id) }}"
                                    id="delete-form-{{ $brand->id }}" method="POST" class="d-inline formDelete">
                                    @csrf
                                    @method('DELETE')
