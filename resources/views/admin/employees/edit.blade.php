<form action="{{ route('admin.employees.update', $employee->id) }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="dni" name="dni"
                    value="{{ old('dni', $employee->dni) }}" placeholder="12345678" maxlength="8" required>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="names" name="names"
                    value="{{ old('names', $employee->names) }}" placeholder="Juan Carlos" maxlength="100" required>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="lastnames" name="lastnames"
                    value="{{ old('lastnames', $employee->lastnames) }}" placeholder="Pérez García" maxlength="200"
                    required>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group" id="license-group"
                style="{{ strpos(strtolower($employee->employeeType->name ?? ''), 'conductor') !== false ? '' : 'display: none;' }}">
                <label for="license">Licencia de Conducir <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="license" name="license"
                    value="{{ old('license', $employee->license) }}" placeholder="A12345678" maxlength="20"
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="phone" name="phone"
                    value="{{ old('phone', $employee->phone) }}" placeholder="987654321" maxlength="20">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="email" name="email"
                    value="{{ old('email', $employee->email) }}" placeholder="empleado@ejemplo.com" maxlength="100">
            ...
            <div class="form-group">
                ...
                <div class="mt-2">
                    <small class="form-text text-muted">
                        @if ($employee->photo)
                            <i class="fas fa-info-circle"></i> El empleado ya tiene una foto. Selecciona una nueva
                            imagen solo si deseas cambiarla.
                        @else
                            <i class="fas fa-info-circle"></i> Selecciona una imagen si deseas agregar una foto al
                            empleado.
                        @endif
                    </small>
                </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="password" name="password"
                    placeholder="Dejar vacío para mantener actual" minlength="8">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="address" name="address"
            value="{{ old('address', $employee->address) }}" placeholder="Av. Principal 123, Distrito, Ciudad"
    ...
    <div class="alert alert-info">
        ...
        <strong>Nota:</strong> Los campos marcados con (*) son obligatorios. La contraseña solo se cambia si se
...
<script>
    $(document).ready(function() {
        ...
        const currentLicense = "{{ $employee->license }}";
        const currentDni = "{{ $employee->dni }}";

        // Establecer fecha máxima (18 años atrás desde hoy)
        const today = new Date();
        const maxDate = new Date(today.getFullYear() - 18, today.getMonth(), today.getDate());
        const maxDateStr = maxDate.toISOString().split('T')[0];
        $('#birthday').attr('max', maxDateStr);
        ...
        function validateField(fieldName, value) {
            ...
            if (rule.unique && value && value.trim() !== '') {
                const currentValues = {
                    'dni': currentDni,
                    'email': currentEmail,
                    'phone': currentPhone,
                ...
                // Solo verificar unicidad si el valor cambió
                if (value.trim() !== currentValues[fieldName]) {
        ...
        window.validateAge = function(fieldName, value) {
            if (!value) {
                setFieldError(fieldName, 'La fecha de nacimiento es obligatoria');
                return false;
            }
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.unique) {
                        ...
                        setFieldError(field, `Este ${fieldNames[field]} ya está registrado`);
                    }
                },
                error: function() {
                    setFieldValid(field);
        ...
        let timeoutId;
        $('#dni, #email, #license, #phone').on('input', function() {
            const fieldName = $(this).attr('name');
            const value = $(this).val();
