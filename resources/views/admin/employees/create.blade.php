<form action="{{ route('admin.employees.store') }}" method="POST" id="employeeCreateForm">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="names" name="names" placeholder="Juan Carlos"
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="lastnames" name="lastnames" placeholder="Pérez García"
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group" id="license-group" style="display: none;">
                ...
                <input type="text" class="form-control" id="license" name="license" placeholder="A12345678"
                    maxlength="20">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="phone" name="phone" placeholder="987654321"
                    maxlength="20">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="email" name="email"
                    placeholder="empleado@ejemplo.com" maxlength="100">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="address" name="address"
            placeholder="Av. Principal 123, Distrito, Ciudad" maxlength="200" required>
...
<script>
    $(document).ready(function() {
        ...
        function checkUnique(field, value) {
            // Si el valor está vacío, no validar unicidad
            if (!value || value.trim() === '') {
                setFieldValid(field);
                return;
            }
            ...
            $.ajax({
                ...
                error: function() {
                    // Si hay error en la petición, no bloquear el formulario
                    setFieldValid(field);
                }
            });
        }
        ...
        $('#dni, #email, #license, #phone').on('input', function() {
            ...
            timeoutId = setTimeout(() => {
                // Solo validar unicidad si hay valor
